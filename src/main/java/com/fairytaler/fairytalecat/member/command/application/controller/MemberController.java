...
public class MemberController {
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponseDTO> updateMemberInfo(@RequestHeader String accessToken, @RequestBody RequestMemberInfoDTO requestMemberInfoDTO) throws Exception {
    ...
    @PutMapping("/profile")
    public ResponseEntity<ResponseDTO> updateProfile(@RequestHeader String accessToken, @ModelAttribute RequestProfileDTO requestProfileDTO) throws Exception {
    ...
    public ResponseEntity<ResponseDTO> updatePwd(@RequestHeader String accessToken, @RequestBody RequestUpdatePwdDTO requestUpdatePwdDTO) throws Exception {
    ...
    @PutMapping("/block")
    public ResponseEntity<ResponseDTO> blockMember(@RequestHeader String accessToken, @RequestBody String memberCode) throws Exception {
        return ResponseEntity.ok().body(new ResponseDTO(HttpStatus.OK, "회원 차단 성공", memberService.blockMember(accessToken, memberCode)));
    }

    @PutMapping("/unblock")
    public ResponseEntity<ResponseDTO> unblockMember(@RequestHeader String accessToken, @RequestBody String memberCode) throws Exception{
    ...
    public ResponseEntity<ResponseDTO> searchPwd(@RequestBody RequestSearchPwdDTO requestSearchPwdDTO) throws Exception{
